...
ROOT_DATASET = '/raid/file2/code2/tsm/data/'  # '/data/jilin/'
...
def return_shad(modality):
    filename_categories = 5
    if modality == 'RGB':
        root_data = ROOT_DATASET + 'SHAD'
        filename_imglist_train = 'SHAD/labels/train_videofolder.txt'
        filename_imglist_val = 'SHAD/labels/val_videofolder.txt'
        # filename_imglist_val = 'FallDet/fall_floor-labels/val_videofolder.txt'
        prefix = '{:04d}.jpg'
    else:
        raise NotImplementedError('no such modality:' + modality)
    return filename_categories, filename_imglist_train, filename_imglist_val, root_data, prefix

def return_falldet(modality):
    filename_categories = 5
    if modality == 'RGB':
        root_data = ROOT_DATASET + 'FallDet'
        filename_imglist_train = 'FallDet/labels/train_videofolder.txt'
        # filename_imglist_val = 'SHAD/labels/val_videofolder.txt'
        # filename_imglist_val = 'FallDet/videos_trimmed/SHAD3-crop-labels/val_videofolder_crop4.txt'
        filename_imglist_val = 'FallDet/labels/val_videofolder.txt'
        prefix = '{:04d}.jpg'
    else:
        raise NotImplementedError('no such modality:' + modality)
    return filename_categories, filename_imglist_train, filename_imglist_val, root_data, prefix
...
def return_dataset(dataset, modality):
    dict_single = {'jester': return_jester, 'something': return_something, 'somethingv2': return_somethingv2,
                   ...
                   'kinetics': return_kinetics,'shad': return_shad,'falldet':return_falldet }
